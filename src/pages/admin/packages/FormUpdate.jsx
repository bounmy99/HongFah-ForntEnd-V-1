...
const FormUpdate = ({
  ...
  useEffect(() => {
    if (parseInt(packageEdit.bonusLevel) === 1) {
      setPL(PerLevel_15);
      setBPL(bonusPer_Level_1);
    } else if (parseInt(packageEdit.bonusLevel) === 3) {
      setPL(PerLevel_35);
      setBPL(bonusPer_Level_3);
    } else if (parseInt(packageEdit.bonusLevel) === 5) {
      setPL(PerLevel_45);
      setBPL(bonusPer_Level_5);
    }
  }, [packageEdit.bonusLevel]);

  // console.log("PL",PL);
  // console.log("BPL",BPL);
  // console.log(packageEdit.bonusLevel)
            ...
            <div className="modal-midium-forms-group">
              <div className="input-group">
                ...
                <input
                  ...
                  className="form-modal-control"
                  onChange={handleChangeUpdate}
                  value={packageEdit?.maintainSaleCondition}
                />
                <span></span>
              </div>
            </div>
              ...
              <div className="modal-midium-forms-group">
                <div className="input-group">
                  ...
                  <input
                    ...
                    name="recommendedFee"
                    className="form-modal-control"
                    value={final2 ? final2 : packageEdit?.recommendedFee}
                    onChange={handleChangeUpdate}
                  />
                  <span className="span-text">PV</span>
                </div>
