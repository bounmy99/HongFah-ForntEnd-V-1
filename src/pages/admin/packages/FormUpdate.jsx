...
const FormUpdate = ({
  ...
  return (
    ...
    //           <h3>ກຳລັງບັນທຶກຂໍ້ມູນ.......</h3>
    //           <CircularProgress style={{ color: "#0EC89C" }} />
    //         </Stack>
    //       ) : (
    //         <h3>ແກ້ໄຂແພັກເກດ</h3>
    //       )}
    ...
    //                 value={packageEdit && packageEdit.packageName}
    ...
    //                 name="PV"
    //                 className="form-modal-control"
    //                 value={packageEdit && packageEdit.PV}
    //                 onChange={handleChangeUpdate}
    //               />
    ...
    //               type="text"
    //               name="price"
    //               value={packageEdit && packageEdit.price}
    //               className="form-modal-control"
    //               onChange={handleChangeUpdate}
    //             />
    ...
    //               type="text"
    //               name="recommendedFee"
    //               value={packageEdit && packageEdit.recommendedFee}
    //               className="form-modal-control"
    //               onChange={handleChangeUpdate}
    //             />
    //             <span className="span-text">PV</span>
    ...
    //               type="text"
    //               name="percentShare"
    //               value={packageEdit && packageEdit.percentShare}
    //               className="form-modal-control"
    //               onChange={handleChangeUpdate}
    //             />
    //             <span className="span-text">%</span>
    ...
    //               type="text"
    //               name="other"
    //               value={packageEdit && packageEdit.other}
    //               className="form-modal-control"
    //               onChange={handleChangeUpdate}
    //             />
    //             <span></span>
    ...
    <div className="modal-midium-card Card">
      <div className="modal-midium-edit-title">
        {loadingSave ? (
          <Stack sx={{ color: "gray.500" }} spacing={2} direction="row">
            <h3>ກຳລັງບັນທຶກຂໍ້ມູນ.......</h3>
            <CircularProgress style={{ color: "#0EC89C" }} />
          </Stack>
        ) : (
          ...
          <div className="modal-midium-content-img">
            {image ? (
              ...
              />
                ...
                <img
                src={packageEdit.image ? packageEdit.image : previewIMG }
                alt={fileName}
                onClick={() => document.querySelector(".input-file").click()}
                className="uploadImage-package"
              />
          ...
          <div className="modal-midium-form-group">
            ...
            <div className="input-group">
              ...
              <input
                ...
                name="recommendedFee"
                className="form-modal-control"
                value={packageEdit?.recommendedFee}
                onChange={handleChangeUpdate}
              />
              <span className="span-text">PV</span>
            </div>
          ...
          <div className="modal-midium-form-group">
            <div className="input-group">
              ...
              <input
                ...
                name="percentShare"
                className="form-modal-control"
                value={packageEdit?.percentShare}
                onChange={handleChangeUpdate}
              />
              <span className="span-text">%</span>
            </div>
