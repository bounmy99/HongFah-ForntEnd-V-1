                  ...
                  <Link to={`/lineWork/Details/${linework._id}`}>
                    <div className="member-view-box">
                      <div className="member-image">
                        <img src={linework.user_id?.position_id?.icon ? linework.user_id?.position_id?.icon : imagePreview} alt="Member" />
                            ...
                            <>
                              <li key={index}>
                                ...
                                >
                                  <div className="member-view-box">
                                    <div className="member-image">
                                      <img src={level_1.user_id?.position_id?.icon ? level_1.user_id?.position_id?.icon : imagePreview } alt="Member" />
                                      <div className="member-details">
                                        ...
                                        <li key={index}>
                                          ...
                                          >
                                            <div className="member-view-box">
                                              <div className="member-image">
                                                <img
                                                  src={level_2.user_id?.position_id?.icon ? level_2.user_id?.position_id?.icon : imagePreview}
                                                  alt="Member"
                                                />
                                                <div className="member-details">
                                                  <h3>
                                                    ...
                                                    <li key={index}>
                                                      ...
                                                      >
                                                        <div className="member-view-box">
                                                          <div className="member-image">
                                                            <img
                                                              src={level_3.user_id?.position_id?.icon ? level_3.user_id?.position_id?.icon : imagePreview }
                                                              alt="Member"
                                                            />
                                                            <div className="member-details">
                                                              <h3>
