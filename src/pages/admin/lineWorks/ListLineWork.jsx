        ...
        {change !== 2 ?
          <div className="employee-dash-card">
            ...
            <div className="emp-dash-boxes emp-new">
              <div className="number">
                <div className="left">
                  <div className="title-left"> Manager</div>
                  <h5>100</h5>
                </div>
                <div className="right">
                  <div className="icons">
                    <img src={Manager} alt="" className="img-icon" />
                  </div>
                </div>
              </div>
            </div>
            <div className="emp-dash-boxes emp-staff">
              <div className="number">
                <div className="left">
                  <div className="title-left"> Leader</div>
                  <h5>0</h5>
                </div>
                <div className="right">
                  <div className="icons">
                    <img src={Leader} className="img-icon" alt="" />
                  </div>
                </div>
              </div>
            </div>
            <div className="emp-dash-boxes emp-manage">
              <div className="number">
                <div className="left">
                  <div className="title-left">Start</div>
                  <h5>0</h5>
                </div>
                <div className="right">
                  <div className="icons">
                    <img src={Start} className="img-icon" alt="" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="employee-card-header">
            ...
            <div className="search">
              ...
              <div className="input-search">
                <input type="search" onChange={handleChangeSearch}  placeholder="ປ້ອນຂໍ້ຄວາມເພື່ອຄົ້ນຫາ" />
                    ...
                    {change === 2 &&
                      <>
                        ...
                        <div className="market-member">
                          ...
                          <div className="member-card">
                            <div className="icons">
                              <img src={Leader} alt="" className="img-icon" />
                            </div>
                            <div className="text">
                              <h3>Leader</h3>
                              <span>0 ຄົນ</span>
                          ...
                          <div className="member-card">
                            <div className="icons">
                              <img src={Start} alt="" className="img-icon" />
                            </div>
                            <div className="text">
                              <h3>Start</h3>
                              <span>0 ຄົນ</span>
                          ...
                          <div className="member-card">
                            <div className="icons">
                              <img src={BluekDiamond} alt="" className="img-icon" />
                            </div>
                            <div className="text">
                              <h3>Bluek</h3>
                              <span>0 ຄົນ</span>
                          ...
                          <div className="member-card">
                            <div className="icons">
                              <img src={BlackDiamond} alt="" className="img-icon" />
                            </div>
                            <div className="text">
                              <h3>Black</h3>
                              <span>0 ຄົນ</span>
