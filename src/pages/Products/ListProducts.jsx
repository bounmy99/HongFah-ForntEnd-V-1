          ...
          <div className="product-card-header">
            <div className="select">
              ...
              <div className="select-type-menu">
                <div className={`select-type-btn ${openDropType}`} onClick={handleClickOpenType}>
                  {selectedType ? <span className="sBtn-text">{selectedType}</span> : <span className="sBtn-text">ປະເພດສິນຄ້າ</span>}
                  ...
                  <ul className="options-type">
                    {productTypes.map((item, idx) => (
                      <div className="option-type">
                        <option className="option-type-text" value={item._id} onClick={handleClickType} >{item.name}</option>
                      </div>
                    ))}
                  </ul>
                }
              ...
              <div className="select-price-menu">
                <div className={`select-price-btn ${openDropPrice}`} onClick={handleClickOpenPrice}>
                  {selectedPrice ? <span className="sBtn-text">{selectedPrice}</span> : <span className="sBtn-text">ລາຄາສິນຄ້າ</span>}
                  <i className='bx bx-chevron-down'></i>
                </div>
                ...
                {isActiveDropdownPrice &&
                  <ul className="options-price">
                    {ProductPrice.map((item, idx) => (
                      <li className="option-price" key={idx} onClick={handleClickPrice}>
            ...
            <div className="search">
              ...
              {/*  Input search*/}
              <InputSearch setArg={setArg} arg={arg} search={search} setSearch={setSearch} />

              <div className="btn-search">
                <button type="button" onClick={handleSearch}>ຄົ້ນຫາ</button>
              </div>
            </div>
          </div>
          {productsEmpty ?
