...
const FormCreate = ({handleSubmit, handleChangeAdd, handleModalCancel,loadingSave}) =>{
    return (
        <form onSubmit={handleSubmit}>
            <div className="modal-midium-card Card">
                ...
                <div className="modal-midium-input">
                  <div className="modal-midium-form-group">
                    <div className="input-group">
                      ...
                      <input type="text" name="packageName" className="form-modal-control" onChange={handleChangeAdd} />
                      <span></span>
                    </div>
                    <div className="input-group">
                ...
                <div className="modal-midium-input">
                  <div className="modal-midium-form-group">
                    ...
                    <div className="input-group">
                      ...
                      <input type="text" name="other" className="form-modal-control" onChange={handleChangeAdd} />
                      <span></span>
                    </div>
                  </div>
                </div>
              ...
              <div className="modals-midium-btn">
                ...
                <button type="submit" className="modal-midium-btn btn-info" >ຢືນຢັນການເພີ່ມ</button>
              </div>
            </div>
          </form>
    )
