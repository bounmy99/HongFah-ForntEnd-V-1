...
// insert and update package
  ...
  const handleModalEdit = (id) => {
    ...
    setOpenModal(true);
    setLoadingSave(false);
    GetOnePackage(users.token, id).then(res => {
      console.log(res.data.data)
                ...
                <div className="package-add">
                  <div className="package-add-btn">
                    <div className="icon-btn-add">
                      <img src={BtnAddPkg} alt="images-package" className="img-package-add" />
                    </div>
                  ...
                  <div className="package-add-icon-left">
                    <svg xmlns="http://www.w3.org/2000/svg" width="42" height="50" viewBox="0 0 42 50" fill="none">
                      <path d="M-9.42305 43.8294C-2.41527 48.9253 6.29916 50.9858 14.8032 49.5577C23.3072 48.1296 30.9042 43.3298 35.9229 36.2142C40.9416 29.0986 42.9709 20.2501 41.5644 11.6152C40.1579 2.9804 35.4308 -4.73346 28.4231 -9.82937L22.4975 -1.42807C27.3109 2.07212 30.5578 7.37047 31.5238 13.3014C32.4899 19.2324 31.096 25.3101 27.6489 30.1975C24.2017 35.0849 18.9836 38.3817 13.1425 39.3626C7.30147 40.3436 1.31585 38.9283 -3.49752 35.4281L-9.42305 43.8294Z" fill="#D4FAFF" />
                    </svg>
                  </div>
                  <div className="package-add-icon-right">
                    <svg xmlns="http://www.w3.org/2000/svg" width="90" height="69" viewBox="0 0 90 69" fill="none">
                      <path d="M108.384 12.8087C97.3693 4.92041 84.2628 0.47549 70.7219 0.0360441C57.181 -0.403402 43.8139 3.18236 32.3109 10.3399C20.8079 17.4974 11.6857 27.9052 6.09783 40.2472C0.509958 52.5892 -1.2926 66.311 0.918093 79.6775L22.0806 76.1774C20.5621 66.9965 21.8002 57.5715 25.6383 49.0942C29.4764 40.617 35.7421 33.4683 43.6431 28.552C51.544 23.6358 60.7254 21.1729 70.0261 21.4747C79.3268 21.7766 88.3292 24.8296 95.8948 30.2478L108.384 12.8087Z" fill="#D4FAFF" />
                    </svg>
                  </div>
                </div>
              </div>
              {packageList && packageList.slice(0, visible).map((item, idx) => (
                <div className="package-card" key={idx}>
                  <div className="package-header">
                    <div className="package-header-icon-left">
                      <svg xmlns="http://www.w3.org/2000/svg" width="37" height="36" viewBox="0 0 37 36" fill="none">
                        <path d="M-2.56078 35.2951C2.78242 36.3356 8.29968 36.0437 13.5032 34.445C18.7067 32.8464 23.4362 29.9903 27.2736 26.1293C31.1109 22.2682 33.9378 17.5212 35.5044 12.308C37.0709 7.09469 37.3289 1.57573 36.2555 -3.76095L26.0839 -1.71502C26.8212 1.95054 26.644 5.7413 25.568 9.32211C24.4919 12.9029 22.5502 16.1634 19.9145 18.8154C17.2788 21.4674 14.0303 23.4292 10.4562 24.5272C6.88211 25.6253 3.09251 25.8258 -0.577529 25.1111L-2.56078 35.2951Z" fill="white" fillOpacity="0.5" />
                      </svg>
                    </div>
                    <h3 className="package-title">
                      ຕຳແໜ່ງ {item.packageName}
                    </h3>
                    <div className="package-header-icon-right">
                      <svg xmlns="http://www.w3.org/2000/svg" width="68" height="51" viewBox="0 0 68 51" fill="none">
                        <path d="M76.0508 4.70739C67.9524 1.08461 59.0862 -0.487061 50.2359 0.131347C41.3857 0.749754 32.8242 3.53919 25.3083 8.25302C17.7924 12.9669 11.5537 19.4599 7.14376 27.158C2.73382 34.8561 0.288501 43.5222 0.0240037 52.3901L16.9259 52.8942C17.1076 46.8032 18.7872 40.8508 21.8162 35.5633C24.8453 30.2757 29.1304 25.8159 34.2928 22.5781C39.4551 19.3404 45.3357 17.4244 51.4146 16.9997C57.4935 16.5749 63.5834 17.6544 69.1459 20.1428L76.0508 4.70739Z" fill="white" fillOpacity="0.5" />
                      </svg>
                    </div>
                  </div>
                  ...
                  <div className="package-button">
                    <button className="p-btn btn-delete" onClick={() => handleDelete(item._id)}>ລົບ</button>
                    <button className="p-btn btn-edit" onClick={() => handleModalEdit(item._id)}>ແກ້ໄຂ</button>
                  </div>
                </div>
