...
const HomeOrder = () => {
  ...
  useEffect(() => {
    ...
    Overview(getData.token).then(res => {
  ...
  return (
    <div className="list-order-container">
      ...
      <div className="orders-button">
        <button
          type="button"
          className={`btn-order btn-waiting ${
        ...
        <button
          type="button"
          className={`btn-order btn-order-success ${
